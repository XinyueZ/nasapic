...
public final class Prefs extends BasicPrefs {
	public static final int API_SERVER_SWITCH_SCHEDULE = 1800;//sec
	public static final int WALLPAPER_TIME_BASE = 3600000 ;//3600000; //60000;//milisec
	public static final int LOCAL_PUSH = 604800;//604800;//120;//sec
