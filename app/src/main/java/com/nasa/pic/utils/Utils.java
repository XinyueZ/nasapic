...
public final class Utils {
	...
	public static void facebookShare(Context cxt,
		...
		if (!TextUtils.isEmpty(url)) {
			fbDlg = new WebDialog.FeedDialogBuilder(cxt,
			                                        cxt.getString(R.string.applicationId),
			                                        postParams).setName(title)
	...
	public static void share(PhotoDB photoDB,
	                         final Intent intent) {
	...
	public static void share(final String title,
	...
	public static void share(final Context cxt,
	                         final String title,
	                         final String description,
	                         final String url) {
		if (!TextUtils.isEmpty(url)) {
			...
			tinyUrlCall.enqueue(new Callback<Response>() {
				...
				public void onResponse(Call<Response> call,
					...
					if (res.isSuccess()) {
						...
						Intent intent = com.chopping.utils.Utils.getShareInformation(title,
						                                                             text);
